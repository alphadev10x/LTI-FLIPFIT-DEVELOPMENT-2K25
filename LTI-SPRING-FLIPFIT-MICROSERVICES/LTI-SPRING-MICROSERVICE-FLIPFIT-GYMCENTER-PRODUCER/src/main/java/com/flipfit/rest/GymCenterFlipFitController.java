...
public class GymCenterFlipFitController {
	...
	public List<GymCenter> getAllCenters() {
		...
		List<GymCenter> centers = gymCenterFlipFitServiceImpl.getAllCenters();
		if (centers.isEmpty()) {
	...
	public List<GymCenter> getCentersByCity(@PathVariable String city) {
		...
		List<GymCenter> centers = gymCenterFlipFitServiceImpl.getCentersByCity(city);
		if (centers.isEmpty()) {
	...
	public ResponseEntity<GymCenterResponse> registerCenter(@RequestBody CenterDto centerDto) {
		logger.info("Registering new gym center: {}", centerDto.getCenterName());
		GymCenterResponse savedCenter = gymCenterFlipFitServiceImpl.registerCenter(centerDto);
	...
	public ResponseEntity<GymCenter> updateCenter(@PathVariable Long id, @RequestBody GymCenter centerDetails) {
		...
		GymCenter updatedCenter =	gymCenterFlipFitServiceImpl.updateCenter(id, centerDetails);
	...
	public ResponseEntity<GymCenter> getCenterById(@PathVariable Long id) {
		...
		GymCenter center = gymCenterFlipFitServiceImpl.getCenterById(id);
	...
	public ResponseEntity<List<GymCenter>> getCenterByOwnerId(@PathVariable("gymOwnerId") Long gymOwnerId) {
		...
		List<GymCenter> gymCenterList = gymCenterFlipFitServiceImpl.getCentersByOwnerId(gymOwnerId);
